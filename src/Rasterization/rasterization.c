...
int point3DtoPixel_r(point_t* point_ptr, point_t* ret_ptr){
...
int fillTriangle(point_t* p1_ptr, point_t* p2_ptr, point_t* p3_ptr, 
    ...
    point_t p2 = {};
    point_t p3 = {};
    if(point3DtoPixel_r(p1_ptr, &p1) == EXIT_FAILURE || 
       point3DtoPixel_r(p2_ptr, &p2) == EXIT_FAILURE ||
       point3DtoPixel_r(p3_ptr, &p3) == EXIT_FAILURE){
        return EXIT_FAILURE;
    }
