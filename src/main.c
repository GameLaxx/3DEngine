...
int main(int argc, char* argv[]) {
    ...
    // cube 2 (bottom)
    point_t cubeCenter2 = {0,0,1};
    vector_t extend2 = {1,0.5,1};
    cube_t cube2 = {.center=cubeCenter2, .extendVector=extend2};
    object_t object2 = {.content_ptr = &cube2, .color = light_gray, .specular = 40, .reflective=0.3, .type=OT_cube};
    // // cube 3
